...
// Raging Bull Finance
contract bullShare is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 100,000 bShare
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 50000 ether;
    uint256 public constant DAO_FUND_POOL_ALLOCATION = 20000 ether;
    uint256 public constant INSURANCE_FUND_POOL_ALLOCATION = 17500 ether;
    ...
    constructor(
    ...
    ) public ERC20("RagingBull Share", "bSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 bSHARE for initial liquidity deployment
        ...
        insuranceFundRewardRate = INSURANCE_FUND_POOL_ALLOCATION.div(
            VESTING_DURATION
        );
