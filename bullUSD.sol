...
//  Raging Bull Finance
contract bullUSD is ERC20Burnable, Operator {
     ...
     */
    constructor() public ERC20("RagingBull Finance", "bullUSD") {
        _mint(msg.sender, 2000000 ether);//  Lauchpad & Init LP & DAO fund(2,000,000 token)
    }
